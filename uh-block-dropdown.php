...
if ($kiddies) {
  ...
  if ($post->post_parent) {
    echo '<li class="page_item parent-page-block-menu-title"><a href="' . get_post_permalink($post->post_parent) . '">' . get_the_title($post->post_parent) . '</a><span class="caret"></span>';
  } else {
    echo '<li class="page_item parent-page-block-menu-title"><a href="' . get_post_permalink($post->ID) . '">' . get_the_title($post->ID) . '</a><span class="caret"></span>';
  }
